      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 lg:col-span-2 text-center md:text-left">
            <h3 className="text-xl font-semibold text-primary mb-4">ICITIIT'25</h3>
            <p className="text-gray-300 text-sm mb-4">
              The 6th International Conference on Innovative Trends In Information Technology (ICITIIT'25) is an event covering all aspects of software and hardware designs of intelligent and smart computing systems. The conference is technically co-sponsored by IEEE Kerala Section.
            </p>
            <p className="text-gray-300 text-sm mb-4">
              ICITIIT'25 allows attendees to benefit from various topics that cover state-of-art Information Technology research and development.
            </p>
            <p className="text-gray-300 text-sm">
              Accepted and presented papers will be submitted for possible publication in IEEE Xplore.
            </p>
          ...
          <div className="text-center md:text-left">
            <h3 className="text-xl font-semibold text-primary mb-4">Useful Links</h3>
            <ul className="space-y-2">
              {usefulLinks.map((link, index) => (
                <li key={index}>
                  <a 
                    href={link.link} 
                    className="text-gray-300 hover:text-primary text-sm flex items-center transition-colors justify-center md:justify-start"
                  >
            ...
            <h3 className="text-xl font-semibold text-primary mt-8 mb-4">Previous Versions</h3>
            <ul className="space-y-2">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-3">
              <p className="text-gray-300 text-sm flex items-start justify-center md:justify-start">
                <svg className="w-5 h-5 mr-3 mt-0.5 flex-shrink-0 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-gray-300 text-sm flex items-center justify-center md:justify-start">
                <svg className="w-5 h-5 mr-3 flex-shrink-0 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex flex-col justify-between items-center">
          <p className="text-sm text-gray-400 text-center mb-4 md:mb-0">
            © {new Date().getFullYear()} ICITIIT'25. All rights reserved. <br className="md:hidden" />
