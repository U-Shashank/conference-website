  ...
  return (
    <div className="relative overflow-hidden w-full py-16 px-4 flex flex-col items-center justify-center text-center rounded-lg shadow-lg">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <div
          className={`transition-all duration-1000 delay-300 transform ${visible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
        >
          <p className="text-white font-bold tracking-wider mb-2 md:text-xl">
            <span className="bg-black bg-opacity-30 px-4 py-1 rounded-full">
              13-14 February 2026
            </span>
          </p>
        </div>
        ...
        <div
          className={`transition-all duration-1000 delay-500 transform ${visible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
        >
          <h1 className="text-white font-extrabold leading-tight tracking-tighter mt-4 mb-4 px-4 text-3xl sm:text-5xl md:text-6xl lg:text-7xl">
            7<sup className="ml-1">th</sup> INTERNATIONAL CONFERENCE ON
        ...
        <div
          className={`transition-all duration-1000 delay-700 transform ${visible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
        >
        ...
        <div
          className={`transition-all duration-1000 delay-900 transform ${visible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
        >
          <p className="mt-4 text-white bg-black bg-opacity-20 px-6 py-2 rounded-lg inline-block font-medium text-lg md:text-xl italic">
            Theme: AI, Automation, and Beyond: Pioneering Trends in Information
            Technology
          </p>
        </div>
      </div>
